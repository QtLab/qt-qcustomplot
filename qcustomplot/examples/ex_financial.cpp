#include "ex_financial.h"

EXFinancial::EXFinancial(QWidget * parent) : QDialog(parent)
{
...
EXFinancial::~EXFinancial()
{

}

void EXFinancial::InitLayout()
{
    QHBoxLayout * pLayoutM = new QHBoxLayout(this);

    pLayoutM->addWidget(m_Plot);
}

void EXFinancial::showEvent(QShowEvent * )
{

}

void EXFinancial::drawStockPlot()
{
